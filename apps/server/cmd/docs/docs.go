    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "minimum": 0,
                        "type": "integer",
                        "description": "Top N selling products",
                        "name": "top",
                        "in": "query"
                    },
                    {
                        "minimum": 0,
                        "type": "integer",
                        "description": "Forward window days for inventory projection",
                        "name": "window_days",
                        "in": "query"
                    }
                ],
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "user, token, refresh_token",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/me": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "user (+ tenant if available)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/password/forgot": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "success message; in dev includes reset_token",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/password/reset": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "invalid or expired token / invalid payload",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/suppliers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Only active suppliers",
                        "name": "active",
                        "in": "query"
                    }
                ],
        ...
        "/suppliers/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update supplier payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
