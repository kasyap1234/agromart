...
type PurchaseOrder struct {
	...
	PurchaseOrderItems []PurchaseOrderItem `json:"items,omitempty" gorm:"foreignKey:PurchaseOrderID"`
}
...
type PurchaseOrderItem struct {
	...
	QuantityReceived *decimal.Decimal `json:"quantity_received,omitempty" gorm:"type:numeric"`
	UnitCost         decimal.Decimal  `json:"unit_cost" gorm:"type:numeric"`
	TotalCost        decimal.Decimal  `json:"total_cost" gorm:"type:numeric"`
